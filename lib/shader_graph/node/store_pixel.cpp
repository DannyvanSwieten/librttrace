...
namespace shadergraph {
	void StorePixelNode::output_instruction(CompilerContext& ctx, IOContext& io_ctx)
	{
		...
		io_ctx.set_instruction(m_output_index, { StorePixel{ image_index, location, color } }, ctx);
	}

	void StorePixelNode::add_io(IOContext& io_ctx)
	{
